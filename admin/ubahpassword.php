<?php 
  ...
  if($_SESSION['level'] == 1 ) {
    ...
    if (isset($_POST['simpan'])) {
      ...
      $konfirmasi = htmlspecialchars($_POST['konfirmasi_password']);

      if ($password === $konfirmasi) {

        mysqli_query($con, "UPDATE pegawai SET password='$password' WHERE idpegawai=$id");
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="editprofil.php"><button type="submit" class="btn btn-primary float-right">Edit Profil</button></a>
          </div>
