<?php 
    ...
    $id = $_GET['id'];
		$kategori = mysqli_query($con, "SELECT * FROM kategori WHERE idkategori=$id");
    ...
    if (isset($_POST["submit"])){
      ...
      if ($valid_kategori){ //escape inputs data
        $kategori = $con->real_escape_string($kategori);
        $query = "UPDATE kategori SET nama_kategori='$kategori' WHERE idkategori=$id";
        $result = $con->query($query);
        if(!$result){
          die("Could not query the database: <br />". $con->error);
        }else{
          echo 'Data has been updated. <br /><br />';
          echo '<a href="index.php">Back to .. data</a>';
          $con->close();
          exit;
        }
      }
